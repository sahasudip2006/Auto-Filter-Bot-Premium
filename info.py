...
# Bot Admins
ADMINS = environ.get('ADMINS', '5165943027') #apni tg id daalo
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001565949579') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002022000663') #support group id ex:  -1002936246860
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001787034706") #if is_stream = true then add a channel id ex: -10026393639
